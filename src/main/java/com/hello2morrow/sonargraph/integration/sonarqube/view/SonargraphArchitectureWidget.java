...
public class SonargraphArchitectureWidget extends AbstractRubyTemplate implements RubyRailsWidget
{
    ...
    {
        //Use an absolute path if you want to develop the ruby template.
        //e.g. "D:/00_repos/00_e4-sgng/com.hello2morrow.sonargraph.integration.sonarqube/src/main/resources/sonargraph_architecture_widget.html.erb"
    ...
    public String getId()
    {
        return SonargraphPluginBase.PLUGIN_KEY.toLowerCase() + "_architecture";
    }

    @Override
    public String getTitle()
    {
        return SonargraphPluginBase.SONARGRAPH_PLUGIN_PRESENTATION_NAME + " Architecture";
    }
}